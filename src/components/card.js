...
function Card() {
  ...
  return (
    <>
      {state.map((card) => (
        <div key={card.id} className="card relative bg-[#2C363F] m-2 flex flex-col items-center  rounded-lg p-2 h-96">
          <ImageWrapper src={card.image} />
          <AboutInfo title={card.title} desc={card.description} />
